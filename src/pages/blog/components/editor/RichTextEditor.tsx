  ...
  const addImage = useCallback(async () => {
    ...
    input.onchange = async (e) => {
      ...
      try {
        ...
        // Always use relative URL for uploads (nginx will proxy correctly)
        ...
        // The URL from the server is already correct (e.g., /uploads/...)
        // It will be served through the same domain via nginx proxy
