      ...
      <div className="lg:grid lg:grid-cols-4 lg:gap-8">
        ...
        <article className="col-span-3 min-w-0 w-full">
          ...
          <header className="mb-8">
            ...
            <h1 className="text-4xl font-bold mb-4 text-blog-text-primary">{post.title}</h1>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-medium text-blog-text-primary">{post.author_data?.name || 'Anonymous'}</div>
                <div className="text-sm text-blog-text-muted">{post.author_data?.email || ''}</div>
              </div>
            </div>
          </header>
        ...
        {toc.length > 0 && (
          <aside className="hidden lg:block">
            <div className="sticky top-24">
              <h2 className="text-lg font-semibold mb-4 text-blog-text-primary">Table of Contents</h2>
                  ...
                  <button
                    ...
                    className={`block text-left w-full text-sm transition-colors ${
                      activeHeading === item.id
                        ? 'text-blog-accent font-medium'
                        : 'text-blog-text-secondary hover:text-blog-text-primary'
                    } ${
